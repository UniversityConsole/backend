    ...
    W: WriterTrait,
{
    ...
    fn serialize_bool(self, value: bool) -> Result<()> {
        self.writer.insert_value(AttributeValue::Bool(value));
        Ok(())
    }
    ...
    fn serialize_bytes(self, value: &[u8]) -> Result<()> {
        self.writer
            .insert_value(AttributeValue::B(aws_smithy_types::Blob::new(value)));
        Ok(())
    }

    fn serialize_unit(self) -> Result<()> {
        self.writer.insert_value(AttributeValue::Null(true));
        Ok(())
    }
    ...
    W: WriterTrait,
{
    ...
    fn end(self) -> Result<()> {
        self.ser
            .writer
            .insert_value(AttributeValue::L(self.current.list.clone()));
        Ok(())
    }
}
    ...
    W: WriterTrait,
{
    fn new(
        ...
        let wrapper_to_close = if ser.writer.is_in_object() {
            ...
            (&mut writer).insert_value(AttributeValue::S(variant.to_string()));
            if has_values {
    ...
    W: WriterTrait,
{
    ...
    fn end(self) -> Result<()> {
        if let Some(mut wrapper) = self.wrapper_to_close {
            ...
            self.ser
                .writer
                .insert_value(AttributeValue::M(self.values_writer.root.clone()));
        }
        Ok(())
    }
}
    ...
    W: WriterTrait,
{
    ...
    fn end(self) -> Result<()> {
        if !self.is_root {
            self.ser
                .writer
                .insert_value(AttributeValue::M(self.current.root.clone()));
        }
        Ok(())
    }
}
